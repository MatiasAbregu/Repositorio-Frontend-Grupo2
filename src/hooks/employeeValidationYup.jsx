...
/**
 * Función que devuelve un esquema de validación Yup para datos de empleados.
 * @returns {yup.ObjectSchema<object>} Esquema de validación Yup para datos de empleados.
 */
